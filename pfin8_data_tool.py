    ...
    try:
        ...
        if chart_type == "Bar Chart":
            ...
            if facet_col and facet_col in chart_data.columns and chart_data[facet_col].nunique() > 1 and len(facet_dims) >= 2:
                ...
                # Identify secondary dimension (the axis/x variable)
                ...
                if sec_col and sec_col in chart_data.columns:
                    ...
                    if x_order_key in category_orders:
                        ...
                        sec_vals = [v for v in _xo if v in sec_vals] + [v for v in sec_vals if v not in _xo]
                else:
                    sec_vals = [None]
                    sec_col = None
...
def run_analysis(config, df_years, df_genpop):
    ...
    if chart_type != "Table":
        ...
        # show a short label ("Response" / "Number of Hours") under each facet's x-axis,
    ...
    if config["chart_type"] == "Table" and chart_data is not None and not chart_data.empty:
        ...
        for _ri, _fv in enumerate(_facet_vals):
            ...
            _exp_fig.add_annotation(
                ...
                x=-0.03, y=_ey_top - _erh / 2, showarrow=False,
        ...
        _exp_fig.update_layout(
            margin=dict(l=70, t=160, r=200, b=20),
            height=_exp_h,
            width=_exp_w,
            legend=dict(
